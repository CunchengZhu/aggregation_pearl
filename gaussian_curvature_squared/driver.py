...
def localRun():
    ...
    g.meshProcessor.meshMutator.minimumEdgeLength = 0.002 * lengthScale
    g.meshProcessor.meshMutator.maximumEdgeLength = 0.02 * lengthScale
    g.meshProcessor.meshMutator.curvTol = 0.01 / lengthScale
